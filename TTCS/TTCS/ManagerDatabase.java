    ...
    public static void importUngVien(ArrayList<UngVien> uv) throws SQLException {
        ...
        try {
            for (UngVien ungVien : uv) {
                ...
                String sqlCandidate = "insert into Candidate(HoTen,NgayThangNamSinh,DiaChi,QueQuan,SoDienThoai,Email) values('"+ungVien.getHoTen()+"', '"+ungVien.getNgayThangNamSinh()+"', '"+ungVien.getDiaChi()+"', '"+ungVien.getQueQuan()+"','"+ungVien.getSoDT()+"', '"+ungVien.getEmail()+"')";
