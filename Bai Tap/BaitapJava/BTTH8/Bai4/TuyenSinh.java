...
public class TuyenSinh {
    Vector<ThiSinh> thiSinhs = new Vector<>();
    ...
    public void hienThiSinh(){
        Enumeration<ThiSinh> en = thiSinhs.elements();
        while (en.hasMoreElements()){
            System.out.println(en.nextElement());
        }
    }

    public Vector<ThiSinh> timKiem(String soBaoDanh){
        Vector<ThiSinh> dsThiSinh = new Vector<>();
