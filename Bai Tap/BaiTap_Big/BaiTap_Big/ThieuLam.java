...
public class ThieuLam extends MonPhai implements BoHanhVi {
    ...
    public ThieuLam(String tenKyNang, float satThuong, String thuocTinh, String moTa, String tenMonPhai, String tenTruongMon, String noiO, String monQuy, String moTa1, String doAN, String thoiGian, String diaDiem, String vuKhi) {
    ...
    public void luyenCong() {
        System.out.println("Thieu lam dang luyen " + kyNang + " bang vu khi " + vuKhi);
    }

    @Override
    public void anUong() {
        System.out.println("Thieu lam dang an do an " + doAN + " voi thoi gian " + thoiGian + " o dia diem " + diaDiem);
    }
