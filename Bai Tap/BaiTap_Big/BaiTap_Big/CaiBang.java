...
public class CaiBang extends MonPhai implements BoHanhVi {
    ...
    public CaiBang(String tenKyNang, float satThuong, String thuocTinh, String moTa, String tenMonPhai, String tenTruongMon, String noiO, String monQuy, String moTa1, String doAN, String thoiGian, String diaDiem, String vuKhi) {
    ...
    public void AnXin(){
        System.out.println("Cai bang dang an xin ");
    }

    @Override
    public void luyenCong() {
        System.out.println("Cai bang dang luyen " + kyNang + " bang vu khi " + vuKhi);
    }

    @Override
    public void anUong() {
        System.out.println("Cai bang dang an do an " + doAN + " voi thoi gian " + thoiGian + " o dia diem " + diaDiem);
    }
